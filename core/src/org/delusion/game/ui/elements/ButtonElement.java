...
public class ButtonElement extends TextElement {
    ...
    public static void load() {
        atlas = new TextureAtlas(Gdx.files.internal("atlas/button.atlas"));
    }

    public void render(SpriteBatch batch) {
        super.render(batch);
        batch.draw(atlas.findRegion("sprite", this.anim_frame), this.getPosition().x + this.getSize().x + 10.0F, this.getPosition().y - this.getSize().y, this.getSize().y, this.getSize().y);
